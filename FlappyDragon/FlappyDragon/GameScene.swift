...
//  FlappyDragon
//
//  Created by Desenvolvimento Candeias on 30/11/21.
//
...
class GameScene: SKScene {
    ...
    func spawnEnemies() {
        let initialPositon = CGFloat(arc4random_uniform(132) + 74)
        ...
        enemyTop.position = CGPoint(x: size.width + enemyWidth/2, y: size.height - initialPositon + enemyHeight/2)
